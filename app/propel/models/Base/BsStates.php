...
/**
 * Base class that represents a row from the 'bs_states' table.
 *
 * 
 *
 * @package    propel.generator.AuBoisDesSylves.Propel.Models.AuBoisDesSylves.Propel.Models.Base
 */
abstract class BsStates implements ActiveRecordInterface 
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\AuBoisDesSylves\\Propel\\Models\\Map\\BsStatesTableMap';
    ...
    /**
     * Initializes internal state of AuBoisDesSylves\Propel\Models\Base\BsStates object.
     */
    ...
    /**
     * Compares this with another <code>BsStates</code> instance.  If
     * <code>obj</code> is an instance of <code>BsStates</code>, delegates to
     * <code>equals(BsStates)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|BsStates The current object, for fluid interface
     */
     ...
     * @return $this|\AuBoisDesSylves\Propel\Models\BsStates The current object (for fluent API support)
     */
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[BsStatesTableMap::COL_ID] = true;
        }
    ...
    public function setName($v)
    {
        ...
        if ($this->name !== $v) {
            $this->name = $v;
            $this->modifiedColumns[BsStatesTableMap::COL_NAME] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : BsStatesTableMap::translateFieldName('Id', TableMap::TYPE_PHPNAME, $indexType)];
            $this->id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : BsStatesTableMap::translateFieldName('Name', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 2; // 2 = BsStatesTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\AuBoisDesSylves\\Propel\\Models\\BsStates'), 0, $e);
        }
    }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildBsStatesQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see BsStates::setDeleted()
     * @see BsStates::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildBsStatesQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                BsStatesTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        $this->modifiedColumns[BsStatesTableMap::COL_ID] = true;
        if (null !== $this->id) {
            throw new PropelException('Cannot insert a value for auto-increment primary key (' . BsStatesTableMap::COL_ID . ')');
        }

         // check the columns in natural order for more readable SQL queries
        if ($this->isColumnModified(BsStatesTableMap::COL_ID)) {
            $modifiedColumns[':p' . $index++]  = 'id';
        }
        if ($this->isColumnModified(BsStatesTableMap::COL_NAME)) {
            $modifiedColumns[':p' . $index++]  = 'name';
        }

        $sql = sprintf(
            'INSERT INTO bs_states (%s) VALUES (%s)',
    ...
    {
        $pos = BsStatesTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if (isset($alreadyDumpedObjects['BsStates'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['BsStates'][$this->hashCode()] = true;
        $keys = BsStatesTableMap::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
            $keys[1] => $this->getName(),
        );
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\AuBoisDesSylves\Propel\Models\BsStates
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\AuBoisDesSylves\Propel\Models\BsStates The current object, for fluid interface
     */
    ...
    {
        $criteria = new Criteria(BsStatesTableMap::DATABASE_NAME);

        if ($this->isColumnModified(BsStatesTableMap::COL_ID)) {
            $criteria->add(BsStatesTableMap::COL_ID, $this->id);
        }
        if ($this->isColumnModified(BsStatesTableMap::COL_NAME)) {
            $criteria->add(BsStatesTableMap::COL_NAME, $this->name);
        }
    ...
    {
        $criteria = ChildBsStatesQuery::create();
        $criteria->add(BsStatesTableMap::COL_ID, $this->id);
     ...
     * objects.
     *
     * @param      object $copyObj An object of \AuBoisDesSylves\Propel\Models\BsStates (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \AuBoisDesSylves\Propel\Models\BsStates Clone of current object.
     * @throws PropelException
     */
     ...
     * If this ChildBsStates is new, it will return
     ...
     * @param      ConnectionInterface $con Optional connection object
     * @return $this|ChildBsStates The current object (for fluent API support)
     */
    public function setBsOrderss(Collection $bsOrderss, ConnectionInterface $con = null)
    {
        ...
        foreach ($bsOrderssToDelete as $bsOrdersRemoved) {
            $bsOrdersRemoved->setBsStates(null);
        }
     ...
     * Otherwise if this BsStates is new, it will return
     * an empty collection; or if this BsStates has previously
     * been saved, it will retrieve related BsOrderss from storage.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in BsStates.
     *
     * @param      Criteria $criteria optional Criteria object to narrow the query
     * @param      ConnectionInterface $con optional connection object
     ...
     * @return ObjectCollection|ChildBsOrders[] List of ChildBsOrders objects
     */
    public function getBsOrderssJoinBsUsers(Criteria $criteria = null, ConnectionInterface $con = null, $joinBehavior = Criteria::LEFT_JOIN)
    {
        $query = ChildBsOrdersQuery::create(null, $criteria);
        $query->joinWith('BsUsers', $joinBehavior);
    ...
    {
        return (string) $this->exportTo(BsStatesTableMap::DEFAULT_STRING_FORMAT);
    }
